...
# three strings team_name2, strategy_name, and strategy_description
...
for module in modules:
    ...
    for required_variable in ['team_name2', 'strategy_name', 'strategy_description']:
...
def make_section0(modules, scores):
    ...
    for index in range(len(modules)):
        ...
        section0 += str(modules[index].team_name2) + ', ' + str(modules[index].strategy_name) + '\n'
...
def make_section2(modules, scores):
    ...
    section2_list = []
    for index in range(len(modules)):
        section2_list.append((modules[index].team_name2,
                              'P'+str(index),
    ...
    for team in section2_list:
        team_name2, Pn, n_points, strategy_name = team
        section2 += '{:<10}({}): {:>10} points with {:<40}\n'.format(team_name2[:10], Pn, n_points, strategy_name[:40])
    return section2
...
def make_section3(modules, moves, scores, index):
    ...
    section3 += modules[index].team_name2 + '\n'
    section3 += '-'*80+'\n'
    ...
    for opponent_index in range(len(modules)):
        if opponent_index != index:
            ...
            section3 += ' pt/round: ' + modules[index].team_name2 +'(P'
            section3 += str(index)+') "'+modules[index].strategy_name + '"\n'
            # Line 2
            section3 += str(scores[opponent_index][index])
            section3 += ' pt/round: ' + modules[opponent_index].team_name2 +'(P'
